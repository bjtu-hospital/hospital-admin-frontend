...
const handleAddMajor = () => {
  ...
  //   .then(response => {
  //     majorDepartments.value.push(response.data)
...
const handleAddMinor = () => {
  ...
  //   .then(response => {
  //     minorDepartments.value.push(response.data)
...
const loadData = () => {
  ...
  //   .then(response => {
  //     majorDepartments.value = response.data.data
  //   })
  
  // departmentApi.getMinorDepartments()
  //   .then(response => {
  //     minorDepartments.value = response.data.data
  //   })
}
